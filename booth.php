                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      if ($bt_status == 1) {
                        ...
                        echo '<p><a  href="./all-status/bt-status.php?id=' . $id  . '&action=0" ><button class="success">Active</button></a></p>';
                      } else if ($bt_status == 0) {

                        echo '<p><a href="./all-status/bt-status.php?id=' . $id  . '&action=1"><button  class="error">Inactive</button></a></p>';
                      }
                      ?>
                    </td>
